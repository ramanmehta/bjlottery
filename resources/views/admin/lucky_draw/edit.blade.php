              ...
              <div class="card-body">
                <div class="form-row">
                  <div class="form-group col-md-12">
                    <label for="game_title">Game Title: <strong class="text-danger">*</strong></label>
                    <input type="text" class="form-control" id="game_title" placeholder="Enter game title"
                      name="game_title" value="{{$luckyDraw->game_title}}" required>
                  </div>
                ...
                <div class="form-row">
                  <div class="form-group col-md-12">
                    <label for="game_description">Game Description: <strong class="text-danger">*</strong></label>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <label>Date and time range: <strong class="text-danger">*</strong></label>
                  ...
                  <div class="form-group col-md-6">
                    <label for="winning_prize_amount">Winning Prize Amount </label>(Optional)
                    <input type="number" class="form-control" id="winning_prize_amount" placeholder="Enter game title"
                      name="winning_prize_amount" value="{{$luckyDraw->winning_prize_amount}}" min="0">
                  </div>
                </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <label for="minimum_prize_amount">Minimum Prize Amount</label>(Optional)
                    <input type="number" class="form-control" id="minimum_prize_amount"
                      placeholder="Enter maximum point" name="minimum_prize_amount"
                      value="{{$luckyDraw->minimum_prize_amount}}" min="0">
                  </div>

                  <div class="form-group col-md-6">
                    <label for="points_per_ticket">Points Per Ticket: <strong class="text-danger">*</strong></label>
                    <input type="number" class="form-control" id="points_per_ticket"
                ...
                {{-- <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="datetime-local" class="form-control" name="start_date_time" id="start_date_time"
                      value="{{$luckyDraw->start_date_time}}">
