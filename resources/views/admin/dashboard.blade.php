...
<body>
   ...
   <a href="/admin/logout"><input type="button" value="Logout"></a>
</body>
</html> -->
...
<head>
  ...
  <title>Bumberjeet | Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('dist/img/favicon.png') }}" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
      <a href="/admin/logout"><input type="button" class="btn btn-primary btn-block" value="Logout"></a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
      ...
      <img src="{{ asset('dist/img/favicon.png') }}" alt="BJ Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <?php $user = session()->get('ADMIN_USER');?>
          <a href="#" class="d-block" > <?php echo $user[1]; ?> </a>
        </div>
      </div>
