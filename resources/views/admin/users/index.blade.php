                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      &nbsp;&nbsp;
                      <a onclick="return confirm('Are you sure remove user : {{$users->name}}?')" href="/admin/deleteUsers/{{encrypt($users->id)}}"><button type="button" class="btn btn-danger" ><i class='fas fa-trash-alt'></i>&nbsp;Remove</button></a> 
