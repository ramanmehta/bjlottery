...
{   
    ...
    public function index(Request $request)
    {
        if($request->has('search')){
            ...
            $luckyDraw = LuckyDrawGames::orderBy('id', 'DESC')->paginate(2);;
    ...
    {   
       // dd($request->all());
        ...
        $validErrArr = [];                
        if($image != null){
            $validArr['game_image'] = ['mimes:jpeg,jpg,png,gif|required'];
            $validErrArr['game_image'] = ['required'=>'upload image is required','mimes'=>'Only images with extension jpeg,jpg,png,gif are allowed.'];
        }
